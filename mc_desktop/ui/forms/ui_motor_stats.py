...
class Ui_Motor_Form(object):
    ...
    def retranslateUi(self, Motor_Form):
        ...
        self.limit_behavior_cb.setItemText(0, QCoreApplication.translate("Motor_Form", u"Off", None))
        self.limit_behavior_cb.setItemText(1, QCoreApplication.translate("Motor_Form", u"Offset Stage", None))
        self.limit_behavior_cb.setItemText(2, QCoreApplication.translate("Motor_Form", u"Stop Only", None))
